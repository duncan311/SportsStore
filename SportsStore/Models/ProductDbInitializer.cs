...
namespace SportsStore.Models
{
    public class ProductDbInitializer : DropCreateDatabaseAlways<ProductDbContext>
    {
        protected override void Seed(ProductDbContext context)
        {
            ...
            new List<Order>
            {
                new Order() { Customer="Alice Smith", TotalCost=68.45m, Lines=new List<OrderLine>() {new OrderLine() {ProductId=2, Count=2}, new OrderLine() { ProductId=3, Count=1 }}},
                new Order() { Customer="Peter Jones", TotalCost=79791m, Lines=new List<OrderLine>() {new OrderLine() {ProductId=5, Count=1}, new OrderLine() { ProductId=6, Count=3 }, new OrderLine() {ProductId=1, Count=3}}}
